    ...
    cards: [
      {
        ...
        descriptionLines: [
          ...
          "Seamless integration with existing systems for enhanced workflows.",
          "Scalable architecture to support future growth and technology advancements.",
          "Implements robust security measures to ensure data protection and reliability.",
        ],
      },
      {
        image: mobile2,
      ...
      },
      {
        ...
        descriptionLines: [
          "Creates user-friendly and intuitive apps tailored for Android devices.",
          "Leverages the latest Android tools and technologies for optimal performance.",
          "Ensures compatibility across a wide range of Android devices and versions.",
          "Focuses on delivering secure, high-performance, and visually appealing applications.",
        ],
      },
      {
        image: mobile4,
        ...
        descriptionLines: [
          "Builds apps compatible with multiple platforms, reducing development costs.",
          "Delivers a consistent user experience across iOS, Android, and other platforms.",
          "Utilizes advanced frameworks like Flutter and React Native for efficient development.",
          "Enables faster time-to-market without compromising functionality or quality.",
        ],
      },
      {
        image: mobile5,
        ...
        descriptionLines: [
          "Facilitates secure access to enterprise data and tools on mobile devices.",
          "Enhances productivity through streamlined workflows and real-time connectivity.",
          "Provides scalable solutions to meet the demands of growing organizations.",
          "Integrates with existing IT infrastructure while ensuring compliance with industry standards.",
        ],
      },
    ],
  },
