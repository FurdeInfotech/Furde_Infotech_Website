  ...
  return (
    <>
      ...
      <div className="w-full mx-auto">
        ...
        <div ref={certificateRef} className="certificate-inner relative bg-white shadow-2xl overflow-hidden w-full" style={{ aspectRatio: "16/12" }}>
        {/* SVG Background with decorative border */}
        <svg className="absolute inset-0 w-full h-full" viewBox="0 0 1200 900" preserveAspectRatio="none">
          <defs>
            ...
            <pattern id="decorPattern" x="0" y="0" width="40" height="40" patternUnits="userSpaceOnUse">
              <path d="M 20 14 L 21.5 18.5 L 26 18.5 L 22.5 21.5 L 24 26 L 20 23 L 16 26 L 17.5 21.5 L 14 18.5 L 18.5 18.5 Z" fill="#d4af37" opacity="0.3" />
            </pattern>
          ...
          <rect x="30" y="30" width="1140" height="840" fill="none" stroke="url(#borderGradient)" strokeWidth="4" />
          <rect x="40" y="40" width="1120" height="820" fill="none" stroke="#d4af37" strokeWidth="2" opacity="0.7" />
          <rect x="50" y="50" width="1100" height="800" fill="none" stroke="#f4e4c1" strokeWidth="1" opacity="0.5" />

          {/* Top-left corner flower */}
          <g transform="translate(70, 70)">
            <use href="#flowerCorner" />
            <circle cx="0" cy="0" r="20" fill="none" stroke="#d4af37" strokeWidth="1" opacity="0.3" />
          </g>
          ...
          <rect x="50" y="50" width="1100" height="800" fill="url(#decorPattern)" />
        </svg>
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-between p-4 sm:p-6 md:p-8 text-center">
          ...
          <div className="flex-1 flex flex-col justify-start w-full ">
            ...
            <div className="py-2 sm:py-2 md:py-2">
              ...
              >
              <defs>
                <path id="headerCurve" d="M 20,80 Q 500,15 980,80" fill="none" />
              </defs>
              <text
                fontSize="60"
                fontWeight="bold"
              ...
              >
                <textPath href="#headerCurve" startOffset="50%" textAnchor="middle">
                  Certificate of <tspan fill="#b45309">{getCertificateTitle()}</tspan>
                </textPath>
              </text>
            </svg>
          ...
          <div className="flex items-center  justify-evenly w-full px-0 sm:px-4 md:px-10 pb-2 sm:pb-4 md:pb-8 gap-1 sm:gap-4 md:gap-8">
            ...
            <div className="flex flex-col items-center gap-0.5 sm:gap-1">
              ...
              <p className="text-[6px] sm:text-[8px] md:text-[8px] font-semibold text-slate-600 tracking-wide">VERIFY</p>
              <a 
                href={certificateUrl}
                target="_blank"
                rel="noopener noreferrer"
                className="text-[5px] sm:text-[7px] md:text-[7px] text-blue-600 hover:text-blue-800 underline max-w-[80px] sm:max-w-[100px] truncate text-center"
                title={certificateUrl}
              >
                {certificateUrl.replace(/^https?:\/\/(www\.)?/, '').slice(0, 20)}...
              </a>
            </div>
            ...
            <div className="flex flex-col items-center gap-0.5 sm:gap-2">
              ...
              <p className="text-[7px] sm:text-[9px] md:text-xs font-semibold text-slate-600 tracking-wide">DATE AWARDED</p>
            </div>
          </div>
        </div>
      </div>
